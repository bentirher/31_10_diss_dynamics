...
def get_circuit(n:int, omega_m:list, omega_c:list, g:list, gamma:list, kappa:list, initial_state:list, r:int, backend:Union[str, BackendV1, BackendV2]) -> QuantumCircuit:
